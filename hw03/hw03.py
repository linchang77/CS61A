...
def interleaved_sum(n, odd_term, even_term):
    ...
    """
    "*** YOUR CODE HERE ***"
    def assitent(total,n, odd_term, even_term):
        if n>total:
            return 0
        return odd_term(n)+assitent(total,n+1,even_term, odd_term)
    return assitent(n,1,odd_term,even_term)
...
def count_coins(total):
    ...
    def f(n,m):
        if n<0:
            ...
            return f(n,next_smaller_coin(m))+f(n-m,m)
    return f(total,25)
