...
def merge(lst1, lst2):
    ...
    "*** YOUR CODE HERE ***"
    """一个写的滂臭的答案"""
    def mergeone(lst1,num1,lst2,num2):
        if num1>=len(lst1):
            return lst2[num2:]
        if num2>=len(lst2):
            return lst1[num1:]
        if lst1[num1]<=lst2[num2]:
            return [lst1[num1]]+mergeone(lst1,num1+1,lst2,num2)
        else:
            return [lst2[num2]]+mergeone(lst1,num1,lst2,num2+1)
    return mergeone(lst1,0,lst2,0)
